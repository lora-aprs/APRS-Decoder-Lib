...
void test_FactoryPositionIn() {
  ...
  // TEST_ASSERT_EQUAL_STRING("AB1CDE", pos->getPath().toString().c_str());
  TEST_ASSERT_EQUAL_DOUBLE(123.123, pos->getLatitude());
  TEST_ASSERT_EQUAL_DOUBLE(123.123, pos->getLongitude());
