...
void test2()
{
	...
	TEST_ASSERT_EQUAL_STRING("@101733z1234.12N/12345.12E_247/000g002t043r002p002P...h83b10191WX - Linz - Nord", msg.getAPRSBody()->getData().c_str());
}
...
void test3()
{
	...
	TEST_ASSERT_EQUAL_STRING("!1234.12N/12345.12E-PHG4450 B8/BH4ABC APRS iGate 438.650MHz 12.4V", msg.getAPRSBody()->getData().c_str());
}
